...
use taiji_engine_types::{commit_result::RejectReason, instruction::Instruction};
use taiji_template_lib::{
    args,
    constants::CONFIDENTIAL_TAIJI_RESOURCE_ADDRESS,
    models::{Amount, ComponentAddress},
};
use taiji_template_test_tooling::{test_faucet_component, TemplateTest};
...
fn deducts_fees_from_payments_and_refunds_the_rest() {
    ...
    let orig_balance: Amount = test.call_method(account, "balance", args![CONFIDENTIAL_TAIJI_RESOURCE_ADDRESS], vec![]);
    ...
    let new_balance: Amount = test.call_method(account, "balance", args![CONFIDENTIAL_TAIJI_RESOURCE_ADDRESS], vec![]);
...
fn another_account_pays_partially_for_fees() {
    ...
    let orig_balance: Amount = test.call_method(
        account_fee,
        "balance",
        args![CONFIDENTIAL_TAIJI_RESOURCE_ADDRESS],
        vec![],
    );
    ...
    let balance: Amount = test.call_method(account, "balance", args![CONFIDENTIAL_TAIJI_RESOURCE_ADDRESS], vec![]);
...
fn failed_fee_transaction() {
    ...
    let initial_balance: Amount =
        test.call_method(account, "balance", args![CONFIDENTIAL_TAIJI_RESOURCE_ADDRESS], vec![]);
