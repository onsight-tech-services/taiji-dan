...
use taiji_dan_engine::runtime::VirtualSubstates;
use taiji_dan_storage::{consensus_models::Block, StateStore, StorageError};
...
const LOG_TARGET: &str = "taiji::dan::validator_node::virtual_substate";
...
pub enum VirtualSubstateError {
    ...
    EpochManagerError(#[from] taiji_epoch_manager::EpochManagerError),
