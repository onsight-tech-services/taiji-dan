...
use taiji_dan_common_types::{optional::Optional, ShardId};
...
use taiji_template_lib::{
    ...
    prelude::{ComponentAddress, ResourceType, CONFIDENTIAL_TAIJI_RESOURCE_ADDRESS},
    Hash,
};
...
const LOG_TARGET: &str = "taiji::dan::wallet_daemon::handlers::transaction";
...
pub async fn handle_reveal_funds(
    ...
    task::spawn(async move {
        ...
        let vault = sdk
            .accounts_api()
            .get_vault_by_resource(&account.address, &CONFIDENTIAL_TAIJI_RESOURCE_ADDRESS)?;
        ...
        if req.pay_fee_from_reveal {
            builder = builder.with_fee_instructions(vec![
                Instruction::CallMethod {
                    ...
                    args: args![CONFIDENTIAL_TAIJI_RESOURCE_ADDRESS, reveal_proof],
                },
...
pub async fn handle_confidential_transfer(
    ...
    task::spawn(async move {
        ...
        let src_vault = accounts_api.get_vault_by_resource(&account.address, &CONFIDENTIAL_TAIJI_RESOURCE_ADDRESS)?;
